...
here's what the bridge list looked like in this system

Bridge Array

0  [DAC_0,BUF_IN,Net 4],1  [10,TOP_R,Net 2],    2  [10,15,Net 2],       3  [FGP_1,15,Net 2],    
4  [11,BOT_R,Net 3],    5  [FGP_2,20,Net 6],    6  [FGP_3,23,Net 7],    7  [FGP_4,25,Net 8],    
8  [FGP_5,27,Net 9],    
...
path	net	node1	chip0	x0	y0	node2	chip1	x1	y1	altPath	sameChp	dup	pathType	chip2	x2	y2
0	d0	DAC_0	K	7	0	BUF_IN	K	2	0	0	1	0	NANO to SF 
1	T	10	B	11	3	TOP_R	K	4	1	0	0	0	BB to SF 
2	T	10	B	4	3	15	C	2	1	0	0	0	BB to BB 
3	T	FGP_1	@	-1	-1	15	@	-1	-1	0	255	0	VIRTUAL 
4	B	11	B	5	4	BOT_R	K	5	2	0	0	0	BB to SF 	C 	3 	0 	13 	0 	C  
5	6	FGP_2	@	-1	-1	20	@	-1	-1	0	255	0	VIRTUAL 
6	7	FGP_3	@	-1	-1	23	@	-1	-1	0	255	0	VIRTUAL 
7	8	FGP_4	@	-1	-1	25	@	-1	-1	0	255	0	VIRTUAL 
8	9	FGP_5	@	-1	-1	27	@	-1	-1	0	255	0	VIRTUAL 
...
note they show as completely unrouted, this was causing dead shorts because the system didn't know they were connected to anything.


this is what the current system looks line for the same setup

Bridge Array

0  [DAC_0,BUF_IN,Net 4],1  [10,FGPO1,Net 6],    2  [10,15,Net 6],       3  [15,FGPI4,Net 6],    
4  [11,FGPO1,Net 7],    5  [20,FGPI4,Net 8],    6  [23,FGPI4,Net 9],    7  [25,FGPI4,Net 10],   
8  [27,FGPI4,Net 11],   
...
path	net	node1	chip0	x0	y0	node2	chip1	x1	y1	altPath	sameChp	dup	pathType	chip2	x2	y2
0	d0	DAC_0	K	7	0	BUF_IN	K	2	0	0	1	0	NANO to SF 
1	6	10	B	11	3	FGPO1	K	4	1	0	0	0	BB to SF 
2	6	10	B	4	3	15	C	2	1	0	0	0	BB to BB 
3	6	15	C	13	1	FGPI4	K	8	2	0	0	0	BB to SF 
4	7	11	B	6	4	FGPO1	K	4	3	0	1	0	BB to SF 	D 	2 	0 	15 	0 	D  
5	8	20	C	8	6	FGPI4	K	8	4	0	1	0	BB to SF 	E 	4 	0 	1 	0 	E  
6	9	23	D	10	2	FGPI4	K	8	5	0	1	0	BB to SF 	F 	6 	0 	3 	0 	F  
7	10	25	D	12	4	FGPI4	K	8	6	0	1	0	BB to SF 	G 	6 	0 	5 	0 	G  
8	11	27	D	14	6	FGPI4	K	8	7	0	1	0	BB to SF 	H 	6 	0 	7 	0 	H  
...
I	.    .    .    .    .    .    .    .    .    .    .    .    .    .    .    .    	.    .    .    .    .    .    .    .     
J	.    .    .    .    .    .    .    .    .    .    .    .    .    .    .    .    	.    .    .    .    .    .    .    .     
K	.    .    d0   .    6    .    .    d0   6    .    .    .    .    .    .    .    	d0   6    6    7    8    9    10   11    
L	.    .    .    .    .    .    .    .    .    .    .    .    .    .    .    .    	.    .    .    .    .    .    .    .     



I like how they show in the netlist, but the issue is that they're each getting their own path, even though only one will ever be connected at a time for the inputs
...
path	net	node1	chip0	x0	y0	node2	chip1	x1	y1	altPath	sameChp	dup	pathType	chip2	x2	y2
0	d0	DAC_0	K	7	0	BUF_IN	K	2	0	0	1	0	NANO to SF 
1	6	10	B	11	3	FGPO1	K	4	1	0	0	0	VIRTUAL 
2	6	10	B	4	3	15	C	2	1	0	0	0	BB to BB 
3	6	15	C	13	1	FGPI0	K	8	2	0	0	0	VIRTUAL 
4	7	11	B	6	4	FGPO1	K	4	1	0	1	0	VIRTUAL  	
5	8	20	C	8	6	FGPI1	K	8	2	0	1	0	VIRTUAL 	
6	9	23	D	10	2	FGPI2	K	8	3	0	1	0	VIRTUAL  	  
7	10	25	D	12	4	FGPI3	K	8	3	0	1	0	VIRTUAL 	
8	11	27	D	14	6	FGPI4	K	8	3	0	1	0	VIRTUAL  	
...
I	.    .    .    .    .    .    .    .    .    .    .    .    .    .    .    .    	.    .    .    .    .    .    .    .     
J	.    .    .    .    .    .    .    .    .    .    .    .    .    .    .    .    	.    .    .    .    .    .    .    .     
K	.    .    d0   .    6    .    .    d0   6    .    .    .    .    .    .    .    	d0   FGP1   FGP2    FGP3    .    .    .    .    
L	.    .    .    .    .    .    .    .    .    .    .    .    .    .    .    .    	.    .    .    .    .    .    .    .     



I did this by hand so the exact routing might not work, but the point is all the fakeGPIO inputs are now overlapping and sharing nodes because only one will ever be connected at a time for the inputs, so they have a direct path

The differences from this old system is that we shouldn't use direct sendXYraw calls anymore, we should use the new path-based system.

but we also need the new system to work


I think we need to make a generalized TimeDomainMultiplexer.cpp that can be used for all the fakeGPIO inputs and use it for other stuff too

We should add new fucntions to CH446Q.cpp that can load an entire state array at once, and then apply it to the chip.

So then how we do the time domain multiplexing is by captuing the entire state with that adc connected, then storing that xy state with the fake gpio so we apply the new full state to sitch between fake gpio inputs
...
int fakeGpioConfigOutput(int node, float v_high, float v_low, float threshold_high, float threshold_low) {
    ...
    while (clear_idx < 5 || add_idx < add_count) {
        ...
        if (add_idx < add_count) {
            ...
            if (which == 0) {
                addBridgeToState(node, needed_high_node, 0, true);
            } else {
                addBridgeToState(node, needed_low_node, 0, true);
            }
            add_idx++;
        }
    }
...
int fakeGpioConfigOutputNodes(int node, int high_node, int low_node, float threshold_high, float threshold_low) {
    ...
    while (clear_idx < 5 || add_idx < add_count) {
        ...
        if (add_idx < add_count) {
            int which = add_order[add_idx];
            if (which == 0) {
                addBridgeToState(node, high_node, 0, true);
            } else {
                addBridgeToState(node, low_node, 0, true);
            }
            add_idx++;
        }
    }
